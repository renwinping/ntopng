...
class Prefs {
 private:
  ...
  bool dump_flows_on_es, dump_flows_on_mysql, dump_flows_on_ls, dump_flows_on_nindex, dump_flows_on_mqtt;
 ...
 public:
  ...
  inline bool  do_dump_flows_on_mqtt()                  { return(dump_flows_on_mqtt);     };
  inline bool  do_dump_flows()                          { return(dump_flows_on_es || dump_flows_on_mysql || dump_flows_on_ls || dump_flows_on_nindex|| dump_flows_on_mqtt); };
