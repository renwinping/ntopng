...
#define CONST_DEFAULT_TS_NUM_STEPS_KY 0 
  ...
  dump_flows_on_es = dump_flows_on_mysql = dump_flows_on_ls =  dump_flows_on_mqtt = false;
...
void usage() {
  printf("ntopng %s%s v.%s - " NTOP_COPYRIGHT "\n\n"
	 ...
	 "[--zmq-encryption]                  | Enable ZMQ CURVE encryption\n"
	 "[--zmq-encryption-key <key>]        | ZMQ CURVE secret key (self-generated by default) \n"
#endif
